...
function printIngredients(pieQuantity, pieType, recipe) { 
...
const printCostEachPie = function(recipe) {
...
const printRevenue = function(costOfPie, pieQuantity, profitMargin) { 
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  printIngredients(pieQuantity, pieType, recipe); 

  // Print the cost of each pie based on the cost of each ingredient
  const costOfPie = printCostEachPie(recipe); 
